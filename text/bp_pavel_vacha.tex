...
V Pythonu poté pomocí rozhraní tuto metodu volám a ukládám data do JSON souboru.  TODO: Rozšířit a upravit tento odstavec 
 
TODO: Popsat získání SDK a problémy s tím spojené

\lstset{caption={Získání dat z IRIS}} 
\begin{lstlisting}[frame=single]
import iris

args = {"hostname": "172.16.42.251", "port": 51774, 
		"user":"censored", 
		"password":"censored", 
		"namespace":"censored"}
		
conn = iris.connect(**args)
irispy = iris.createIRIS(conn) # Instance IRIS objektu

# Zavolání metody na dálku
data = irispy.classMethodString("PVTest.Test", "GetData", 2549)

# Ulozeni dat
with open(f"data_{data.id}.json", "w") as out:
	json.dump(data, out, indent=4)
\end{lstlisting}

TODO: Ukázat práci s globály na straně serveru
