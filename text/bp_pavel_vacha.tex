...
Na grafu \ref{fig:xgboost_learning_curve} výše lze vidět, že validační ztráta se pořád snaží konvergovat k nule. Zároveň je trénovací a  validační ztráta blízko k sobě. To naznačuje, že se model dobře přizpůsobuje datové sadě a nemělo by zde dojit k přeučení.
